...
<body>
    ...
    <main id="main">
        <div id="game">
            <div id="blackjack">
                <div id="score" onclick="gameEnds()"></div>
                <div id="croupier_cards" class="deck">
                    <div class="card"   id="temp1"></div>
                    <div class="card" id="temp0"></div>
                    </div>
                    <h3 id="opp">Dealer:</h3>
                <div id="filler3"></div>
                    <h3 id="ur">You:</h3>
                <div id="your_cards" class="deck">
                    <div class="card" id="temp2"></div>      
                    <div class="card " id="temp3"></div>
                </div>
            ...
            <div id="place_bet_container">
                <form action="">
                    ...
                    <input type="submit" id="submit" value="Play" onclick="startgame(event)">   
                </form>
            </div>
        </div>
    ...
    <script>window.userSaldo = <?php echo json_encode($userSaldo); ?>;</script>
