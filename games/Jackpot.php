...
<body>
    ...
    <main id="main">
        <div id="game">
            ...
            <div id="gamee">
                <div id="wheeel">
                    <img src="../games/wheel_arrow.png" alt="Wheel Arrow" id="arrow">
                    <img src="../games/wheel.png" alt="Wheel of Fortune" id="wheel">
                </div>

                <div id="place_bet_container">
                    <form action="" onsubmit="return false;">
                        <input type="number" value="33" id="input" min="33" max="50000">
                        <input type="submit" id="submit" value="Spin" onclick="rotateObject(event)">   
                    </form>
                </div>
            </div>
