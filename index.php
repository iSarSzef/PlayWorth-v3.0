        ...
        <div class="container" id="main_container">
            <div class="container" id="games_mini">
                <div class="container" id="fold_games">
                    ...
                    <p>Games</p>
                    <a href="" class="container" onclick="minifold(event)" id="minifoldd">
                        <img src="/others/arrow.png" alt="arrow">
                    </a>
                </div>
                <div id="game_links">
                    ...
                    <div class="row">
                        <a href="/games/jackpot.php">
                            <img src="/game_icons/small/wheel_mini.png" alt="">
                            <p>Jackpot</p>
                        </a>
                    </div>
                    <div class="row">
                        <a href="/games/ThisOrThat.php">
                            <img src="/game_icons/small/cards.png" alt="">
                            <p>This Or That</p>
                        </a>
                    </div>
                    <div class="row">
                        <a href="/games/Blackjack.php">
                            <img src="/game_icons/small/cards.png" alt="">
                            <p>Blackjack</p>
                        </a>
                    </div>
                    <div class="row">
                        <a href="/games/Slots.php">
        ...
        <div id="category">
            ...
            <div id="games">
                <div class="game_container">
                    <a href="/games/jackpot.php">
                        <p>Jackpot</p>
                        <img src="/game_icons/WofF.png" alt="">
                    </a>
                </div>
                <div class="game_container">
                    <a href="/games/ThisOrThat.php">
                        <p>This Or That</p>
                        <img src="/game_icons/TorT.png" alt="">
                    </a>
                </div>
                <div class="game_container">
                    <a href="/games/BlackJack.php">
                        <p>Blackjack</p>
                        <img src="/game_icons/bj.png" alt="">
                    </a>
                </div>
                <div class="game_container">
                    <a href="/games/Slots.php">
                        <p>Slots</p>
                        <img src="/game_icons/slot.png" alt="">
                    </a>
                </div>
                <div class="game_container">
                    <a href="/notfound.php">
                        <p>Mines</p>
                        <img src="/game_icons/mines.png" alt="">
                    </a>
                    <div class="coming_sooon">Coming soon...</div>
                </div>
                <div class="game_container">
                    <a href="/notfound.php">
                        <p>Roulette</p>
                        <img src="/game_icons/roulette.png" alt="">
                    </a>
                    <div class="coming_sooon">Coming soon...</div>
                </div>
                <div class="game_container">
                    <a href="/notfound.php">
                        <p>Cups</p>
                        <img src="/game_icons/cups.png" alt="">
                    </a>
                    <div class="coming_soooon">Coming soon...</div>
                </div>
                <div class="game_container">
                    <a href="/notfound.php">
                        <p>Crash</p>
                        <img src="/game_icons/crash.png" alt="">
                    </a>
                    <div class="coming_soooon">Coming soon...</div>
                </div>
                <div class="game_container">
                    <a href="/notfound.php">
                        <p>Poker</p>
                        <img src="/game_icons/poker.png" alt="">
                    </a>
                    <div class="coming_soooon">Coming soon...</div>
                </div>
            </div>
